...
- This is further supported by computational modeling where stronger synaptic connectivity between the prefrontal and parietal regions, and not faster transmission of signal nor stronger connections within each region, can itself account for the observed changes in working memory.
...
- Another criticism for the skill learning view is that some individuals have early prefrontal lesions but still develop normal intellectual abilities. This would be unexpected if the prefrontal cortex were critical for acquiring new knowledge and skills.

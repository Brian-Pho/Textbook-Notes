...
- Throughout history and even now, the brain has been explained by analogy to the current era's most advance technology.
...
- Over the centuries, each layer of technological metaphor has added something to our understanding.
...
- For most of history, we have viewed the heart, not the brain, as the fundamental organ of thought and feeling.
...
- Heart-centered views match our everyday experience; the heart changes its rhythm at the same time as our feelings change.
- E.g. Anger, love, and fear all cause the heart to beat faster.
- People believed this idea because it made sense.
- The first recorded challenge to our global heart-centered view occurred in ancient Greece at around 600 and 250 BCE.
...
- One researcher, Galen, became certain that the brain was the center of thought and proved so with his experiments on pigs.
- E.g. Galen would expose the pig brain and when pressure was applied to a certain area, the pig would stop moving.
- For over 1200 years, ventricular localization was widely accepted, the idea that mental functions are located in the brain's three ventricle.
- E.g. Sensation and imagination in the front, intellect and reason in the middle, and motion and memory in the back.
...
- Vesalius could understand the body because careful dissection can reveal structures such as bone, muscle, and blood vessel, which imply function.
- However, dissection of the brain leads to no difference at all in the structure as it looks mostly uniform.
...
- Review of Descartes’s ideas about the brain and mind, most of which were false.
...
- Unless we mean the special matter to be neurons, but then the argument only applies to atoms, not living cells.
...
- Introduction to the idea of a reflex.
...
- As we know now in hindsight, this claim is referring to the action potential.
- This conditional, non-mechanical view raised the question of how any known force could fulfill such a role.
- Exciting hints about that this latent force might be came from a new phenomenon that seemed to be linked with life itself: electricity.
...
- Darwin had revealed a principle that could explain why the brains of different animals are different shapes, because they have evolved to produce different behaviors.
...
- The destruction of the cerebral hemispheres leads to unrestrained reflex action.
...
- E.g. The heavier two objects are, the larger the difference between them has to be before we can detect the difference.
...
- One of the greatest scientific achievements of the 19th century was cell theory; the realization that all organisms are made up of cells, and that cells can only come from other cells.
...
- Since only a few cells were stained, this provided support that nerve cells were actually cells and not some continuous network.
- Review of Cajal's work and the history behind the neuron doctrine.
- The telegraph metaphor was prominent in the 19th century.
...
- E.g. Tapping the tendon below your knee causes your thigh muscle to contract, but you can't stimulate your thigh and make your tendon respond.
...
- Review of the disagreement between the electrical (sparks) camp and chemical (soups) camp of synaptic transmission.
...
- The 18th century suggestion that humans were machines was flipped during the 20th century as it seemed that machines would become human.
...
- As with most scientific discoveries, if Adrian hadn't done this work, someone else would have done so at about the same time. That is the nature of science.
- The sensory messages are scarcely more complex than a succession of dots in Morse code.
...
- The sensory illusion demonstrates the clear dependence of the correspondence between perception and the external world upon the specific structural properties of the intervening nervous net.
...
- While no significant insights about the brain were gained post-World War II, there was significant consensus on the argument that the activity of the human brain and the existence of the mind as the same thing.
- During the first half of the 20th century, we explored what the brain does, but not how it might do it. That was left to the second half of the 20th century and brings us to the present.
...
- There are now tens of thousands of neuroscientists around the world in a variety of fields such as cognitive, theoretical, and clinical.
- However, this part will skip over research on sleep, non-visual perception, hormones, emotions, development, and genes.
- Paradoxically, despite the immense progress, it isn't clear if we have the theoretical tools necessary to face the challenges of understanding the brain in the 21st century.

## Chapter 10: Memory

- Review of Wilder Penfield's experiments on stimulating the temporal lobe.
- These experiments suggested that memory might have a very precise location in the brain.
...
- One thing was clear, that there wasn't anything special about the particular evoked memories.
- Recent studies have confirmed the accuracy of Penfield's experimental work.
- The area Penfield stimulated wasn't where memories were stored, but instead the area seemed to be able to trigger the activity of a distant part(s) of the brain where the memory was actually stored.
- This complicated the debate between localized and distributed function.
- Other primates show a different sensory and motor homunculus, suggesting that its a consequence of our evolution and biology.
...
- The hippocampi don't store memories but rather is required to create them.
...
- An interesting finding was that HM couldn't compare two odors and he found it difficult to read a map.
...
- The same goes for the sensory cortex with different columns for different parts of the body and different layers for different kinds of sensory stimuli from the same part of the body.
- Review of the critical period and how the brain changes structure as a consequence of experience.
- HW's work suggested that visual processing in the brain is hierarchically organized.
...
- Worms don't all behave in exactly the same way, unlike a set of machines with the exact same wiring diagram.
...
- Review of the Pandemonium model, perception, and connectionism.
...
- Review of parallel distribution processing (PDP) and deep learning.
...
- E.g. When insects find a mate and need to intercept them while flying.
...
- The fundamental weakness of fMRI is that it's too coarse to allow a real understanding of the computational activity of the brain.
...
- Lesion studies and neuroanatomy clear show structural differences but the problem lies in the logic behind linking structure to function.
- Just because a particular cell is activated doesn't mean that is all the cell does.
...
- Even the direct manipulation of a particular cell or network alters or restores a given function, that still doesn't mean that the function is located in that structure.
...
- However, one clear area for localization is for sensory processing.
...
- Another one is that of mirror neurons.
...
- No one can yet explain why the activity of one set of neurons produces consciousness, whereas that of another doesn't.
- One significant advance in our understanding of consciousness was that there may be aspects of what our brain does when we perceive but that aren't part of consciousness.
- In other words, there are unconscious processes in the brain.
...
- In the last decade or so, the insight provided by Hebb and Crick into how to study consciousness scientifically by focusing on precise, solvable problems seems to have been somewhat forgotten.
- Although there are many ways of theorizing consciousness, there are currently two main scientific approaches, neither of which is widely accepted.
- Review of the global workspace theory and integrated information theory.
...
- In the past, we've used new kinds of technology. This implies that the appearance of new and insightful metaphors for the brain hinges of future technological breakthroughs.

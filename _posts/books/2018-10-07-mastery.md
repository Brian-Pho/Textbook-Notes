...
categories:
  - Books
excerpt: "On the path to mastery."
---
...
It is an intelligence that is not taught in our schools nor analyzed by professors, but almost all of us, at some point, have had glimpses of it in our own experience when we work intensely on a project or under a deadline — under pressure to get results, ideas seem to come to us out of nowhere; we feel [*more mentally active and creative*](https://www.copyblogger.com/mental-blocks-creative-thinking/).
...
I call this power "mastery” and I believe [*anyone can reach it*](https://www.copyblogger.com/master-your-craft/) by following these steps.
...
Such childhood interests spark our deepest curiosity but many of us lose touch with these inclinations. We listen to parents and peers; we choose career paths that promise comfort and money. Because [*we are not deeply connected to the subject or field we choose*](https://www.copyblogger.com/eminem/)to pursue, we do not pay deep attention. Our learning and skill is not exceptional.

Your task in life is to find a way to incorporate these primal inclinations in your career path, to reconnect with what makes you unique and genuinely excites you in life. You will find your calling by thinking back to your childhood, reflecting on these early interests that you may have strayed from. They may be several interests involving several skills. By [*developing these skills*](https://www.copyblogger.com/content-marketing-mastery/) you can then combine them in unusual ways.
...
This means that you move toward [*challenges that will toughen and improve you*](https://www.copyblogger.com/content-marketing-effort/), where you will get the most objective feedback on your performance and progress. You do not choose apprenticeships that seem easy and comfortable.
...
In all fields, the key to ultimate success is acquiring as many skills as possible. This could be something physical such as operating tools or machines, or something more nebulous — [*the ability to research and organize information*](https://www.copyblogger.com/content-marketing-research-2/), or managing people. Whatever the case, at the outset, it is essential that you begin with one skill that you can master, and that serves as a foundation for acquiring others.
...
At the same time, you must [*accumulate knowledge on human nature*](https://www.copyblogger.com/social-psychology-persuasion/), on the common traits and weaknesses that we all possess — such as envy, insecurity, laziness, passive aggression. With such knowledge you can avoid becoming the victim of the sharks in the water.
...
The key to awakening this creative energy is to maintain a fluid, open mind, one that is [*continually looking for connections between ideas and novel perspectives*](https://www.copyblogger.com/content-success/) on problems.
...
The endgame here is to mix your years of discipline and practice with [*a bold and original spirit*](https://www.copyblogger.com/sushi-content-marketing/). One without the other will lead you nowhere.
...
By [*intense absorption in a particular field*](http://scribecontent.com/library/) over a long period of time, Masters come to understand all of the parts involved in what they are studying. They reach a point where all of this has become internalized and they are no longer seeing the parts:
...
Then, let time take its course. [*Creative energies will emerge*](https://www.copyblogger.com/creative-rut/), as will high–level intuition.
...
Source: <https://www.copyblogger.com/robert-greene-mastery/>

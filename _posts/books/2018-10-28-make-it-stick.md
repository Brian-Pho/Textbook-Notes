...
- One, learning requires memory.
- Two, we need to keep learning and remembering all our life.
- Three, learning is an acquired skill.

### Principle claims

- Learning is deeper and more durable when its effortful.
- We are poor judges of when we are learning well and when we're not.
- Rereading text and massed practice of a skill or new knowledge are preferred but are the least productive.
- Retrieval practice is more effective.
- Space out practice or interleave the practice of two or more subjects is more effective.
- Trying to solve a problem before being taught the solution is more effective.
...
- Extract the key ideas from new material and organize them into a mental model and connect that to prior knowledge shows an advantage in learning complex mastery.
- Repetition by itself does not lead to good long-term memory.
- Doing multiple readings in close succession is ineffective.
...
- One of the best habits a learner can instill is regular self quizzing to recalibrate their understanding of what they do and don't know.

### Learning strategies

- Various forms of retrieval practice such as quizzing and self testing.
...
- Practicing retrieval makes learning stick far better than re-exposure to the original material does.This is the testing effect/retrieval-practice effect.
...
- Creativity requires a foundation of knowledge.
...
- Retrieval practice has a significant impact on learning.
...
- Consolidation helps organize and solidify learning, and, notably, so does retrieval after a lapse of some time, because the act of retrieving a memory from long-term storage can both strengthen the memory traces and at the same time make them modifiable again.This process is called reconsolidation.
- Learning, remembering, and forgetting work together in interesting ways.First, as we re-code and consolidate new material from short-term memory into long-term memory, we must anchor it there securely.Second, we must associate the material with a diverse set of cues that will make us adept at recalling the knowledge later.Having effective retrieval cues is an aspect of learning that often goes overlooked.
...
- It is one skill to hit a curveball when you know a curveball will be thrown; it is a different skill to hit a curveball when you don't know its coming.Baseball players need to build the latter skill, but they often practice the former.
...
- A fear of failure can poison learning by creating aversions to the kinds of experimentation and risk taking that characterize striving, or by dimishing performance under pressure.
...
- Its not the failure that's desirable, it's the dauntless effort despite the risks, the discovery of what works and what doesn't that sometimes only failure can reveal.
...
- Learning is at least a three step process: initial encoding, consolidation, and retrieval.
...
- Memory has some similarities to a Google search algorithm.More links then the greater the chance is retrieving it.
...
- The answer to illusion and misjudge meant is to replace subjective experience as the basis for decisions with a set of objective gauges outside ourselves, so that our judgement squares with the real world around us.
...
- Three parts of intelligence, analytical, creative, and practical.
...
- Adopt active learning strategies.Be aggressive with retrieval practice, distri uted, interleaved testing.Don't rely on what feels best.Don't assume that you're doing something wrong if the learning feels hard.
- Distill the underlying principles; build the structure.What kind of scaffold or framework can you imagine that holds these central ideas together.By abstracting the underlying rules and piecing them into a structure, you go for more than knowledge.You go for knowhow and that kind of mastery will put you ahead.
...
- Performance goals VS learning goals.The second goals means you aim for harder tasks and don't try to validate what you already know.
...
- The realization that the power to increase your abilities lies largely within your own control.
...
- Expert performance is a product of the quantity and quality of practice, not of genetic predisposition and that becoming an expert is not beyond the reach of normally gifted people.

...
- Learning, remembering, and forgetting work together in interesting ways.
  - First, as we re-code and consolidate new material from short-term memory into long-term memory, we must anchor it there securely.
...
- Adopt active learning strategies. Be aggressive with retrieval practice, distributed, interleaved testing. Don't rely on what feels best. Don't assume that you're doing something wrong if the learning feels hard.

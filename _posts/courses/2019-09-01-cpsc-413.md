...
- [Asymptotics (4)](#asymptotics-4)
  - [L01: Introduction to course, asymptotics](#l01-introduction-to-course-asymptotics)
  - [L02: (Asymp) Asymptotics, big-Oh notation](#l02-asymp-asymptotics-big-oh-notation)
  - [L03: (Asymp) Limit test, logarithms, exponentials](#l03-asymp-limit-test-logarithms-exponentials)
  - [L04: (Asymp) Classification of exponentials, polynomials, and logarithms](#l04-asymp-classification-of-exponentials-polynomials-and-logarithms)
- [Greedy (5)](#greedy-5)
  - [L05: (Greedy) Interval scheduling 1](#l05-greedy-interval-scheduling-1)
  - [L06: (Greedy) Interval scheduling 2](#l06-greedy-interval-scheduling-2)
  - [L07: (Greedy) Shortest paths in graphs](#l07-greedy-shortest-paths-in-graphs)
  - [L08: (Greedy) Minimum spanning tree](#l08-greedy-minimum-spanning-tree)
  - [L09: (Greedy) Huffman codes](#l09-greedy-huffman-codes)
- [Divide &amp; conquer (4)](#divide-amp-conquer-4)
  - [L10: (D&amp;C) Simple recursive algorithms](#l10-dampc-simple-recursive-algorithms)
  - [L11: (D&amp;C) Largest sum of subarray and Recursions](#l11-dampc-largest-sum-of-subarray-and-recursions)
  - [L12: (D&amp;C) Closest points in the plane](#l12-dampc-closest-points-in-the-plane)
  - [L13: (D&amp;C) FFT - Fast Fourier Transforms](#l13-dampc-fft---fast-fourier-transforms)
- [Dynamic programming (5)](#dynamic-programming-5)
  - [L14: (DP) Scheduling](#l14-dp-scheduling)
  - [L15: (DP) Knapsack and Subset Sum](#l15-dp-knapsack-and-subset-sum)
  - [L16: (DP) Word problems](#l16-dp-word-problems)
  - [L17: (DP) Matrix problems](#l17-dp-matrix-problems)
  - [L18: Algorithmic thinking](#l18-algorithmic-thinking)
- [NP and Reducibility (6)](#np-and-reducibility-6)
  - [L19: (NP) Reducibility](#l19-np-reducibility)
  - [L20: (NP) Satisfiability and NP](#l20-np-satisfiability-and-np)
  - [L21: (NP) Hamiltonian cycle, 3-Coloring — reductions](#l21-np-hamiltonian-cycle-3-coloring--reductions)
  - [L22: (NP) NP and efficient algorithms](#l22-np-np-and-efficient-algorithms)
  - [L23: (NP) NP, NP-completeness, NP-hardness, co-NP](#l23-np-np-np-completeness-np-hardness-co-np)
  - [L24: (NP) NP completeness and hardness, exam preps](#l24-np-np-completeness-and-hardness-exam-preps)
  - [L25: Exam preparations](#l25-exam-preparations)

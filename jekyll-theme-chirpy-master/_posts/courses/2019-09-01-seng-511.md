...
- [2. Why SPM](#2-why-spm)
- [3. Software Measurement](#3-software-measurement)
- [4. Project Risk Management](#4-project-risk-management)
- [5. Project Planning](#5-project-planning)
- [6. Product Planning](#6-product-planning)
- [7. Feature Prioritization](#7-feature-prioritization)
- [8. Software Effort Estimation](#8-software-effort-estimation)
- [9. Case Studies](#9-case-studies)
- [10. Project Time Management](#10-project-time-management)
- [11. Staffing](#11-staffing)
- [12. Project Monitoring &amp; Control](#12-project-monitoring-amp-control)
- [13. Technical Debt](#13-technical-debt)
- [14. Project Monitoring &amp; Statistical Process Control](#14-project-monitoring-amp-statistical-process-control)
- [15. Management of Kanban and Scrum Development](#15-management-of-kanban-and-scrum-development)
- [16. The Essence of Scrum](#16-the-essence-of-scrum)
- [17. Lean and Kanban](#17-lean-and-kanban)
- [18. Process Modeling](#18-process-modeling)
- [19. Software Process Simulation](#19-software-process-simulation)
- [20. Case Studies in Software Engineering](#20-case-studies-in-software-engineering)
- [21. Capability Maturity Model CMM](#21-capability-maturity-model-cmm)
